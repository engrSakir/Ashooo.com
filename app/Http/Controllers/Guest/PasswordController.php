...
*/
        ...
        if ($user->reset_date != Carbon::today() || $user->reset_count < Setting::find(1)->reset_sms_count){
            ...
            $smsSender = new SmsSender();
            $readySms = Setting::find(1)->reset_sms_template.$password.' লগিন করুনঃ '.Setting::find(1)->website;
