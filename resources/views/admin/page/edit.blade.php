...
@push('title')
    Edit  @if(current_language() == 'bn'){{ ($page->bn_name) }} @else {{ ($page->en_name) }} @endif
@endpush
@push('head')
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> @if(current_language() == 'bn'){{ ($page->bn_name) }} @else {{ ($page->en_name) }} @endif</li>
                    </ol>
                </div>
            </div>
            <!-- End Breadcrumb-->
