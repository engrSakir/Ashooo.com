                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total District</span>
                            </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Upazila</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Ads.</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Notice.</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Worker Service Categories</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total  Worker Services</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Membership Service Categories</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Membership Service</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Active Jobs</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Running Jobs</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Completeed Jobs</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Cancel Jobs</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Worker's Income</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Worker's Due Amount</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Referral Income</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media">
                            <div class="media-body text-left">
                                ...
                                <span class="text-white">Total Withdrawn Amount</span>
                            </div>
                            <div class="align-self-center w-icon"><i class="icon-pie-chart text-white"></i></div>
                        </div>
                    </div>
