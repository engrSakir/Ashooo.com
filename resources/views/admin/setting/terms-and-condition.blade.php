                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    <textarea name="" id="english-description" class="summernote" cols="30" rows="10">{{ $setting->en_terms_and_condition }}</textarea>
                                    <button type="button" class="btn btn-danger btn-block waves-effect waves-light mb-1 update">UPDATE</button>
                                </div>
                                <div class="col-6">
                                    <textarea name="" id="bengali-description" class="summernote" cols="30" rows="10">{{ $setting->bn_terms_and_condition }}</textarea>
    ...
    <script>
        $(document).ready(function() {
           ...
           $('.update').click(function(){
               ...
               $.ajax({
                   method: 'POST',
                   url: "{{ route('admin.updateTermsAndCondition') }}",
                   ...
                   success: function (data) {
                       Swal.fire({
                           position: 'top-end',
                           icon: 'success',
                           title: 'Successfully Terms And Condition updated',
