    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    <h4 class="page-title">Referral income system</h4>
                    <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    <textarea name="" id="english-description" class="summernote" cols="30" rows="10">{{ $setting->en_referral_income_system }}</textarea>
                                    <button type="button" class="btn btn-danger btn-block waves-effect waves-light mb-1 update">UPDATE</button>
                                </div>
                                <div class="col-6">
                                    <textarea name="" id="bengali-description" class="summernote" cols="30" rows="10">{{ $setting->bn_referral_income_system }}</textarea>
    ...
    <script>
        $(document).ready(function() {
           ...
           $('.update').click(function(){
               ...
               $.ajax({
                   method: 'POST',
                   url: "{{ route('admin.updateReferralIncome') }}",
                   ...
                   success: function (data) {
                       Swal.fire({
                           position: 'top-end',
                           icon: 'success',
                           title: 'Successfully referral income system updated',
