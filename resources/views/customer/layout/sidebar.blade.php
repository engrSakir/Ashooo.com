    ...
    <div class="row">
        <div class="col">
            <div class="list-group main-menu">
                <a href="{{ route('customer.home.index') }}" class="list-group-item list-group-item-action @if(Route::is('customer.home.index')) active @endif"><i class="material-icons icons-raised">home</i>{{ __('Home') }}</a>
                <a href="{{ route('customer.myJob') }}" class="list-group-item list-group-item-action @if(Route::is('customer.myJob')) active @endif"><i class="material-icons icons-raised">work</i>{{ __('My order') }}</a>
                <a href="{{ route('customer.showGeneralServiceCategory') }}" class="list-group-item list-group-item-action @if(Route::is('customer.showGeneralServiceCategory')) active @endif"><i class="material-icons icons-raised">blur_linear</i>{{ __('Others') }}</a>
                <a href="{{ route('customer.profile.index') }}" class="list-group-item list-group-item-action @if(Route::is('customer.profile.index')) active @endif"><i class="material-icons icons-raised">face</i>{{ __('Profile') }}</a>
