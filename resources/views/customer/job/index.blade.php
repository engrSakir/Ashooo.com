                ...
                <div class="row">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <button id="completed-job-btn" type="button" class="mb-2 btn btn-success">{{ __('completed') }}
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <button id="running-job-btn" type="button" class="mb-2 btn btn-success">{{ __('running') }} &nbsp;
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <button id="cancelled-job-btn" type="button" class="mb-2 btn btn-success">{{ __('cancelled') }}
                        ...
                        <div class="col">
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-3 text-center color-border">
                                    ...
                                    <p class="text-mute small text-secondary mb-2">{{ __('proposal') }}</p>
                                </div>
