    ...
    @elseif($customerBid->status == 'cancelled')
        <!-- Start title -->
            ...
            <div class="container">
                <div class="card bg-danger shadow mt-4 h-190">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-auto">
                                <figure class="avatar avatar-60"><img src="{{ asset('uploads/images/users/'.$customerBid->cancelInfo->canceller->image) }}" alt=""></figure>
                            </div>
                            <div class="col pl-0 align-self-center">
                                <h5 class="mb-1">{{ $customerBid->cancelInfo->canceller->full_name }}</h5>
            ...
            <div class="container">
                ...
                <p>{{ $customerBid->address }}</p>
                <div class="btn-group btn-group-lg btn-group w-100 mb-2 text-center" role="group" aria-label="Basic example">
                    <button disabled type="button" class="btn btn-outline-danger active"><b>Cancelled Date</b> <br> <small> {{ date('h:i:s a m/d/y', strtotime($customerBid->updated_at)) }}</small></button>
                </div>
            </div>
    @endif
    <!-- footer-->
    ...
    <script>
        $(document).ready(function(){
            $("#submit").click(function (){
                ...
                $.ajax({
                    method: 'POST',
                    url: "{{ route('customer.updateMyBidBudget') }}",
